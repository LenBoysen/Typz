...
function Option1 {
    ...
    [Console]::Write("$((New-TimeSpan -Start $startDate -End (Get-Date)).TotalSeconds) s, $mistake mistakes, $($position /  (New-TimeSpan -Start $startDate -End (Get-Date)).TotalSeconds) CPS")
